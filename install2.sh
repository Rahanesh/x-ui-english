...
config_after_install() {
    ...
    if [[ x"${config_confirm}" == x"y" || x"${config_confirm}" == x"Y" ]]; then
        ...
        echo -e "${red}t.me/Rahanesh telegramBot:@ManVPN_bot ${plain}"
...
install_x-ui() {
    ...
    #    echo -e "If you want to 54321 Change to another port，Enter the x-ui command to modify，Also make sure that the port you modify is also released"
    #echo -e ""
